...
public class Influencer_ApprovedCamp extends Fragment {

    private static final String TAG = Influencer_ApprovedCamp.class.getSimpleName();
    ...
    private List<Influencer_ApprovedCamp_Declare> approvedList = new ArrayList<>();
    private ListView listView;
    private Influencer_Approved_ListAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.influencer_approvedcamp, container, false);
...
//        swipeRefreshLayout.setOnRefreshListener(this);
    ...
    private void CampaignsFunction() {
        if (isInternetPresent) {
            ...
            pDialog.show();
            String approved_list = getResources().getString(R.string.base_url_v6) + getResources().getString(R.string.approved_camp_url);
            StringRequest approvedListURL = new StringRequest(Request.Method.POST,approved_list , new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (responstatus.equalsIgnoreCase("true")) {
                            ...
                            for (int i = 0; i < obj1.length(); i++) {
                                try {
                                    ...
                                    Influencer_ApprovedCamp_Declare approvedcamp = new Influencer_ApprovedCamp_Declare();
                        ...
                        adapter = new Influencer_Approved_ListAdapter(getActivity(), approvedList);
            ...
            approvedListURL.setRetryPolicy(policy);
            MyApplication.getInstance().addToRequestQueue(approvedListURL);
    ...
    public static Influencer_ApprovedCamp newInstance() {
        return (new Influencer_ApprovedCamp());
    }

//    @Override
//    public void onRefresh() {
//        swipeRefreshLayout.setRefreshing(true);
//        Influencer_ApprovedCamp fragment = new Influencer_ApprovedCamp();

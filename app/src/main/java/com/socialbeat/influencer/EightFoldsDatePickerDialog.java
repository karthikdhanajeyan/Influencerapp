...
public class EightFoldsDatePickerDialog extends DatePickerDialog {
    ...
    public EightFoldsDatePickerDialog(@NonNull View.OnClickListener context, @Nullable OnDateSetListener listener, int year, int month, int dayOfMonth) {
        super((Context) context, listener, year, month, dayOfMonth);
        datePickerDialog = new DatePickerDialog((Context) context, listener, year, month, dayOfMonth);

...
public class RegistrationActivityOne extends AppCompatActivity {
    ...
    String rname, remail, playstoreversion, rpassword, rmobile, rcity, cid, message, userimage,mCurrentPhotoPath,
            cname,email,cmobileno,ccity, instagram,foi;
...
//                    }
                    if (flg) {
                        ...
                        MyApplication.getInstance().trackEvent("User Registered Button Clicked Event", "OnClick", "Track Registration Event");

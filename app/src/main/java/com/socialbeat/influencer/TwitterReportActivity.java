...
public class TwitterReportActivity extends AppCompatActivity {

    private static final String PREFS_NAME = "TwitterReportActivity";
    private static final int REQUEST_TAKE_PHOTO = 1;
    Context context;
    private CoordinatorLayout coordinatorLayout;
    private static final String TAG = TwitterReportActivity.class.getSimpleName();
    boolean flg = true;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Twitter Report");
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        ustrcalendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(TwitterReportActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View v) {
                if (isInternetPresent) {
                    ...
                    if ((TextUtils.isEmpty(imagesize))) {
                        ...
                        Toast.makeText(TwitterReportActivity.this, "your image is more than 5 MB,so add image below 5 MB", Toast.LENGTH_LONG).show();
                            return;
                    ...
                    if (flg) {
                        ...
                        fsocialmedia = "Twitter";//usocialmedia.getText().toString();
                        freach = ureach.getText().toString();
                        fengagement = uengagement.getText().toString();
                        fpostlink = upostlink.getText().toString();
                        ffromdate = ufromdate.getText().toString();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK) {
            ...
            if (filePath != null) {
                ...
                MediaScannerConnection.scanFile(TwitterReportActivity.this, new String[]{imagepath}, null, new MediaScannerConnection.OnScanCompletedListener() {
...
//                uengagescreenshot.setImageBitmap(bitmapnew);
            ...
            if (filePathengage != null) {
                ...
                // ScanFile so it will be appeared on Gallery
                MediaScannerConnection.scanFile(TwitterReportActivity.this, new String[]{imagepathvalue}, null, new MediaScannerConnection.OnScanCompletedListener() {
                    public void onScanCompleted(String path, Uri uri) {
                    }
                });
            }
    ...
    class UploadFileToServerImage extends AsyncTask<Void, Integer, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pdialog = new ProgressDialog(TwitterReportActivity.this);
...
//                    }
                    ...
                    Intent intent = new Intent(TwitterReportActivity.this, NewHomeActivity.class);
                    ...
                    startActivity(intent);
                    Toast.makeText(TwitterReportActivity.this, message, Toast.LENGTH_LONG).show();

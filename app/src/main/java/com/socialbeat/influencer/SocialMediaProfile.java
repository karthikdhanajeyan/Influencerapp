...
public class SocialMediaProfile extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addhandle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intents = new Intent(SocialMediaProfile.this, SocialMedia.class);
        ...
        facebook_clr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               if (facebookpage.length()!=0){
                   Intent intent = new Intent(SocialMediaProfile.this, FacebookPage.class);
        ...
        instagram_clr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (instagram.length()!=0){
                    Intent intent = new Intent(SocialMediaProfile.this, InstagramPage.class);
                    Bundle bund = new Bundle();
        ...
        twitter_clr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (twitter.length()!=0){
                    Intent intent = new Intent(SocialMediaProfile.this, TwitterPage.class);
                    Bundle bund = new Bundle();
        ...
        youtube_clr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (youtubehandle.length()!=0){
                    Intent intent = new Intent(SocialMediaProfile.this, YoutubePage.class);
                    Bundle bund = new Bundle();
        ...
        blogger_clr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bloglink.length()!=0){
                    Intent intent = new Intent(SocialMediaProfile.this, BloggerPage.class);
                    Bundle bund = new Bundle();
    ...
    private void profileFunction() {
        ...
        pdialog = new ProgressDialog(SocialMediaProfile.this);
...
//
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(SocialMediaProfile.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
...
//                return true;
            case android.R.id.home:
                Intent intent = new Intent(SocialMediaProfile.this, UserSettings.class);

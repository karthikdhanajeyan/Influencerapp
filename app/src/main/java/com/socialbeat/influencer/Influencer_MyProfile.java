...
public class Influencer_MyProfile extends AppCompatActivity {
    ...
    Button psave;
    String mCurrentPhotoPath,location,estate,state,id,cityname=null,statenme,statename=null,cityfinal=null,statefinal=null;
    ...
    String ename,ecity;
    String gender,city,message,response,userimage,name,email,mobile_no;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.influencer_myprofile);
            ...
            public void onClick(View v) {
                if (isInternetPresent) {
                    ...
                    if(egender=="" && egender==null){
                        flg = false;
                        Toast.makeText(Influencer_MyProfile.this,"Select Gender Value",Toast.LENGTH_SHORT).show();
                        return;
                    }
                    estate = statefinal;
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if(responstatus.equalsIgnoreCase("true")){
                            Snackbar snackbar = Snackbar.make(coordinatorLayout, "Profile details updated Successfully", Snackbar.LENGTH_INDEFINITE).setAction("OK", new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                        ...
                        Snackbar snackbar = Snackbar.make(coordinatorLayout, "No data from server.Please try again later.", Snackbar.LENGTH_INDEFINITE).setAction("OK", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent intent = new Intent(Influencer_MyProfile.this, Influencer_Home.class);
                                startActivity(intent);
                            }
                        });
                        snackbar.setActionTextColor(Color.RED);
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    if (networkResponse != null && networkResponse.statusCode == HttpStatus.SC_UNAUTHORIZED) {
                        ...
                        Snackbar snackbar = Snackbar.make(coordinatorLayout, "Session Expired.", Snackbar.LENGTH_INDEFINITE).setAction("Login", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent intent = new Intent(Influencer_MyProfile.this, Influencer_Login.class);
                                startActivity(intent);
                            }
                        });
                        snackbar.setActionTextColor(Color.RED);
...
//                    hidePDialog();
            ...
            case REQUEST_ID_MULTIPLE_PERMISSIONS: {
                ...
                if (grantResults.length > 0) {
                    ...
                    if (perms.get(Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED && perms.get(Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED && perms.get(Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        Intent i = new Intent(Influencer_MyProfile.this, Influencer_Home.class);
    ...
    private void loadSpinnerCityData() {
        if (isInternetPresent) {
            ...
            pDialog.setCancelable(false);
            pDialog.show();
            String city_list = getResources().getString(R.string.base_url_v6) + getResources().getString(R.string.getcity_url);
            StringRequest CITY_LIST = new StringRequest(Request.Method.POST,city_list , new Response.Listener<String>() {
            ...
            RetryPolicy policy = new DefaultRetryPolicy(socketTimeout,
                    DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
                    DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            CITY_LIST.setRetryPolicy(policy);
            MyApplication.getInstance().addToRequestQueue(CITY_LIST);
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Influencer_MyProfile.this);
    ...
    private void dispatchTakePictureIntent() throws IOException {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                ...
                Uri photoURI = FileProvider.getUriForFile(Influencer_MyProfile.this, BuildConfig.APPLICATION_ID + ".provider", createImageFile());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            if (filePath != null) {
                ...
                MediaScannerConnection.scanFile(Influencer_MyProfile.this, new String[]{imageUri.getPath()}, null, new MediaScannerConnection.OnScanCompletedListener() {

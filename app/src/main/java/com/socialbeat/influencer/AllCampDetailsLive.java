...
//        }
        ...
        campaignclosed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MyApplication.getInstance().trackEvent("Campaign Closed Button Clicked Event", "OnClick", "Track Campaign close button Event");
            }
        });
        alreadyapplied.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MyApplication.getInstance().trackEvent("Campaign Applied Button Clicked Event", "OnClick", "Track Campaign Applied button Event");
            }
        });
    ...
    class JSONAsyncTaskSubmit extends AsyncTask<String, Void, String> {

        String url;

        String response = "";
        JSONAsyncTaskSubmit(String url) {
            this.url = url;
        }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                System.out.println(responsemessage);
                System.out.println(responstatus);

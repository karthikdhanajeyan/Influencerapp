...
public class MyWallet extends AppCompatActivity  {
    ...
    CardView recharge,banktransfer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("PaymentMethods");

        recharge =(CardView)findViewById(R.id.paytmtransfer);
        banktransfer =(CardView)findViewById(R.id.banktransfer);
        ...
        if (isInternetPresent) {
           ...
           // walletamount.setText( getResources().getString(R.string.rs)+" : "+"00.00");
            ...
            banktransfer.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(MyWallet.this,"Under Construction :)", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void rechargeUser() {
        ...
        if (isInternetPresent) {
            if (validation == "false") {
                Intent intent = new Intent(MyWallet.this, LoginSmsActivity.class);
                startActivity(intent);
            } else if (validation == "true") {
                pdia = new ProgressDialog(MyWallet.this);
                pdia.setMessage("Please Wait...");
                pdia.setCancelable(false);
                pdia.show();
                String RECHARGE_URL  =  getResources().getString(R.string.base_url) + getResources().getString(R.string.paytm_recharge_url);
                StringRequest stringRequest = new StringRequest(Request.Method.POST, RECHARGE_URL, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            pdia.dismiss();
                            if (response == "true") {
                                transcationId = json.getString("transcationId");
                                //Toast.makeText(MyWallet.this,message, Toast.LENGTH_SHORT).show();
                                ...
                                alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        Intent intent = new Intent(MyWallet.this, NewHomeActivity.class);
                                        startActivity(intent);
                                    }
                     ...
                     /* Alert Dialog Code End*/
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(MyWallet.this, error.toString(), Toast.LENGTH_LONG).show();
                            }
                        }) {
                    @Override
    ...
    private void userinfo() {
        walleturl  = getResources().getString(R.string.base_url)+getResources().getString(R.string.wallet_balance_url)+"?cid="+cid+"&mobile=" + mobileno + "";
    ...
    public void onResume() {
        ...
        MyApplication.getInstance().trackScreenView("Mywallet Screen");
    }

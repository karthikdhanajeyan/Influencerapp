...
public class UserSettingsold extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        editprofile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UserSettingsold.this, MyProfileNew.class);
        ...
        socialmedia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UserSettingsold.this, FacebookAuthentication.class);
                startActivity(intent);
            }
        });
        ...
        paymentmethods.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UserSettingsold.this, WalletOld.class);
                startActivity(intent);
            }
        });
        ...
        paymenthistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UserSettingsold.this, TransactionHistory.class);
                startActivity(intent);
            }
        });
        ...
        policy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(UserSettingsold.this, PrivatePolicy.class);
                startActivity(intent);
            }
        });
        ...
        terms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UserSettingsold.this, TermsCondition.class);
                startActivity(intent);
            }
        });
        ...
        checkupdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (playstoreversion.equals(appversion)){
                    ...
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(UserSettingsold.this);
                    // Setting Dialog Title
                    alertDialog.setTitle("Check Update");
                    // Setting Dialog Message
    ...
    private void profileShownFunction() {
        pdialog = new ProgressDialog(UserSettingsold.this);
            ...
            public void onResponse(String success) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(UserSettingsold.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override

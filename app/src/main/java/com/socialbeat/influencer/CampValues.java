...
//	private String message;
	...
	public CampValues(String campImg, String campName, String campShortNote, String campCat, String campLongNote, String campGoal, String campDos, String campDont,
					  String campBacklink,String campTag,String campid, String campApplyTill,String campRewards,String campRewardType, String fixedamount
						,String campEligibility,String campDeliverables) {
		super();
		...
		this.campEligibility = campEligibility;
		this.campDeliverables = campDeliverables;
	}
	...
	public String getCampEligibility() {
		return campEligibility;
	}

	public void setCampEligibility(String campEligibility) {this.campEligibility = campEligibility;}

	public String getCampDeliverables() {
		return campDeliverables;
	}

	public void setCampDeliverables(String campDeliverables) {this.campDeliverables = campDeliverables;}
}
